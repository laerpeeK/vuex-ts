...
import type { Action, Getter, Mutation } from '@/vuex/types'
describe('Module', () => {
  it('get state', () => {
  ...
  it('forEachChild method', () => {
    ...
    const collections: Array<Module> = []
    module.forEachChild((item) => {
      collections.push(item)
    })
    expect(collections.length).toEqual(2)
    // 调整了顺序，应该为module1, module2
    expect(collections).toEqual([module1, module2])
  })
  ...
  it('forEachAction method', () => {
    ...
    const collections: Array<Action> = []
  ...
  it('forEachGetter method', () => {
    ...
    const collections: Array<Getter> = []
  ...
  it('forEachMutation method', () => {
    ...
    const collections:Array<Mutation> = []
